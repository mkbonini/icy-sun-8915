...
RSpec.describe 'departments index page' do
    ...
    it 'shows the list of employee names in each department' do
        ...
        emp_1 = Employee.create!(name: 'Mark', level: 5, department_id: dept_1)
        emp_2 = Employee.create!(name: 'John', level: 1, department_id: dept_1)
        emp_3 = Employee.create!(name: 'Mary', level: 3, department_id: dept_2)
